 ...
 */
@Component("stadiumFacade")
public class DefaultStadiumFacade implements StadiumFacade {

    private StadiumService stadiumService;

    @Autowired
    public DefaultStadiumFacade(StadiumService stadiumService) {
    ...
    public List<StadiumData> getStadiums() {
        ...
        final List<StadiumData> stadiumFacadeData = new ArrayList<>();
    ...
    public StadiumData getStadium(final String name) {
        ...
        final List<MatchSummaryData> matchSummary = new ArrayList<>();
